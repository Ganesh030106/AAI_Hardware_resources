        ...
        <div className="w-full max-w-[480px] bg-white dark:bg-[#181f2a] rounded-2xl shadow-lg border border-gray-200 dark:border-[#232e42] overflow-hidden">
          ...
          <div className="border-b border-gray-200 dark:border-[#232e42]">
            <div className="flex">
              ...
              {/* Admin Tab (Inactive) */}
              <Link to="/html/AdminLogin.html" className="group flex flex-1 flex-col items-center justify-center gap-2 pt-4 pb-3 relative text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-[#232e42] transition-colors">
                <div className="flex items-center gap-2">
              ...
              <button className="group flex flex-1 flex-col items-center justify-center gap-2 pt-4 pb-3 relative hover:bg-gray-50 dark:hover:bg-[#232e42] transition-colors">
                <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400">
                  ...
                  <span className="text-xs sm:text-sm font-bold tracking-[0.015em]">Technician</span>
                </div>
          ...
          <div className="p-6 sm:p-8 flex flex-col gap-6">
            <div className="text-center">
              <h2 className="text-gray-900 dark:text-white tracking-tight text-[24px] font-bold leading-tight mb-2">Technician Portal</h2>
              <p className="text-gray-500 dark:text-gray-400 text-[15px] font-normal leading-normal">Enter your credentials to manage maintenance tickets.</p>
            </div>
