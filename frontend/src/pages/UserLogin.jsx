...
export default function UserLogin() {
  ...
  return (
    <div className="font-display bg-[#f8fafc] dark:bg-[#101622] min-h-screen flex flex-col relative overflow-x-hidden antialiased">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center min-h-screen p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-8 text-center flex flex-col items-center gap-3">
          ...
          <h1 className="text-gray-900 dark:text-white text-2xl font-bold tracking-tight">Hardware Management Login</h1>
        ...
        <div className="w-full max-w-[480px] bg-white dark:bg-[#181f2a] rounded-2xl shadow-lg border border-gray-200 dark:border-[#232e42] overflow-hidden">
          ...
          <div className="border-b border-gray-200 dark:border-[#232e42]">
            <div className="flex">
              {/* User Tab (Active) */}
              <button className="group flex flex-1 flex-col items-center justify-center gap-2 pt-4 pb-3 relative hover:bg-gray-50 dark:hover:bg-[#232e42] transition-colors">
                <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400">
                  <span className="material-symbols-outlined text-[20px] filled">person</span>
                  <span className="text-xs sm:text-sm font-bold tracking-[0.015em]">User</span>
                </div>
                <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-blue-600 dark:bg-blue-400 rounded-t-full mx-4"></div>
              </button>
              {/* Admin Tab (Inactive) */}
              <Link to="/html/AdminLogin.html" className="group flex flex-1 flex-col items-center justify-center gap-2 pt-4 pb-3 relative text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-[#232e42] transition-colors">
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-[20px] text-gray-400 group-hover:text-gray-950 dark:text-gray-500 dark:group-hover:text-white">admin_panel_settings</span>
                  <span className="text-xs sm:text-sm font-bold tracking-[0.015em] text-gray-500 dark:text-gray-400 group-hover:text-gray-950 dark:group-hover:text-white">Admin</span>
                </div>
        ...
        <footer className="mt-6 mb-2 w-full flex justify-center">
          <span className="text-xs text-[#94a3b8] dark:text-[#64748b]">&copy; 2026 AAI Hardware Maintenance System. All rights reserved.</span>
        </footer>
      </div>
      ...
      {isTermsOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white dark:bg-[#181f2a] rounded-xl shadow-lg max-w-lg w-full p-6 relative mx-4">
            <button onClick={() => setIsTermsOpen(false)} className="absolute top-3 right-3 text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-xl font-bold" aria-label="Close">&times;</button>
      ...
      {isHelpOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white dark:bg-[#181f2a] rounded-xl shadow-lg max-w-md w-full p-6 relative mx-4">
            <button onClick={() => setIsHelpOpen(false)} className="absolute top-3 right-3 text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-xl font-bold" aria-label="Close">&times;</button>
      ...
      {isPrivacyOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white dark:bg-[#181f2a] rounded-xl shadow-lg max-w-md w-full p-6 relative mx-4">
            <button onClick={() => setIsPrivacyOpen(false)} className="absolute top-3 right-3 text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-xl font-bold" aria-label="Close">&times;</button>
      ...
      {isContactOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white dark:bg-[#181f2a] rounded-xl shadow-lg max-w-md w-full p-6 relative mx-4">
            <button onClick={() => setIsContactOpen(false)} className="absolute top-3 right-3 text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-xl font-bold" aria-label="Close">&times;</button>
