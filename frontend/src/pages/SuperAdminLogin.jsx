...
export default function SuperAdminLogin() {
  ...
  const handleSuperAdminLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        // Store SuperAdmin session details
        loginSuperadmin(data.user);
        navigate('/html/SuperAdminDash.html');
      } else {
    ...
    <div className="font-display bg-gray-50 dark:bg-[#101622] min-h-screen flex flex-col relative overflow-x-hidden antialiased">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center min-h-screen p-4 sm:p-6 lg:p-8">
        <div className="mb-8 text-center flex flex-col items-center gap-3">
          ...
          <h1 className="text-gray-900 dark:text-white text-2xl font-bold">Super Admin Login</h1>
          <p className="text-blue-700 dark:text-blue-400 text-sm font-medium">AAI Hardware Super Admin Portal</p>
        </div>

        {/* Login Card */}
        <div className="w-full max-w-[440px] bg-white dark:bg-[#181f2a] rounded-2xl shadow-lg border border-gray-200 dark:border-[#232e42] overflow-hidden">
          {/* Tabs */}
            ...
            <div className="flex">
              <button className="group flex flex-1 flex-col items-center justify-center gap-2 pt-4 pb-3 relative text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-[#232e42] transition-colors">
                <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-bold">
                  ...
                  <span className="text-sm font-bold tracking-[0.015em]">Super Admin Login</span>
                </div>
